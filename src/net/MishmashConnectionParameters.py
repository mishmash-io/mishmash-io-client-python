...
class MishmashConnectionParameters():
    ...
    def __init__(self, config_file_path=None):
        ...
        try:
            ...
            self.__auth_app_id = value_or_exception(self.__raw_connection_parameters["MISHMASHIO_AUTH_APP_ID"])
    ...
    def get_configuration_from_env(self):
            return {
                ...
                "MISHMASHIO_AUTH_APP_ID": os.environ.get("MISHMASHIO_AUTH_APP_ID",None),
